    ...
    <el-container style="width:70%; height: 100%; margin-left: 15%">
        <el-aside width="55%">
            <el-breadcrumb separator-class="el-icon-arrow-right" style="margin-top: 5%; font-size: 24px">
                ...
                <el-breadcrumb-item :to="{ path: '/category/'+ goods.goodsCategoryId}">{{
                        categoryName
                    }}
                </el-breadcrumb-item>
...
export default {
    ...
    mounted() {
        axios.post("http://localhost:8083/goods/goodById", Qs.stringify({good_id: 6}))
            .then(res => {
        ...
        axios.post("http://localhost:8083/goods/goodTest", Qs.stringify({good_id: 6}))
            .then(res => {
